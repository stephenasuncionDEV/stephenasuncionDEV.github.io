...
class node{
    ...
    Draw() {
        ...
        grid.innerHTML += `<div id="node${this.column}_${this.row}" style="width:${nodeSize}px; height:${nodeSize}px; background-color:${stateColor[this.state]}; display:inline-block; border: 2px solid #ededed; box-shadow: 0 4px 10px 0 rgba(0,0,0,0.4);">.<br>.</div>`;
    }
